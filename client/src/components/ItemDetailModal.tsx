...
export default function ItemDetailModal({ itemId, onClose }: ItemDetailModalProps) {
  ...
  return (
    <Dialog open={true} onOpenChange={onClose}>      <DialogContent className="max-w-5xl h-[95vh] p-0 flex flex-col bg-gradient-to-br from-gray-900 via-gray-800/98 to-gray-900/95 backdrop-blur-xl border border-orange-500/20 rounded-3xl shadow-luxury-xl overflow-hidden">
      {/* Close Button */}
      <button
        onClick={onClose}
      ...
      {isLoading || addonsLoading ? (
        ...
        <>
              ...
              <div className="flex-1 overflow-y-auto px-6 pb-6">
                <TabsContent value="customize" className="space-y-6 mt-6">
                  ...
                  {addons && addons.length > 0 && (
                    <div className="space-y-4">
                      <h3 className="text-2xl font-bold bg-gradient-to-r from-gray-300 to-orange-400 bg-clip-text text-transparent flex items-center gap-2">
                      ...
                      {Object.entries(groupAddonsByCategory(addons)).map(([category, categoryAddons]) => (
                        <div key={category} className="glass-card bg-gradient-to-br from-gray-800/60 to-gray-900/40 backdrop-blur-sm border border-gray-700/40 rounded-2xl p-6 shadow-lg">
                          <h4 className="text-xl font-bold text-gray-200 mb-4 capitalize flex items-center gap-2">
          ...
          <div className="border-t border-gray-700/50 bg-gradient-to-r from-gray-900/90 to-gray-800/90 backdrop-blur-sm p-6">
            <div className="flex items-center space-x-6">                <span className="text-lg font-bold text-gray-200">Quantity:</span>
